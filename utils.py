...
from info import DIRECT_GEN, DIRECT_GEN_URL, DIRECT_GEN_DB, SHORTNER_URL, LONG_DROPLINK_URL, SHORTENER_API, AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, STREAM_API, STREAM_SITE, STREAM_URL, STREAM_LONG
